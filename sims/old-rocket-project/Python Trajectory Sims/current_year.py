...
if __name__ == '__main__':
    ...
    motor.thrust_from_rse('/Users/magi-nerv/Desktop/Rocket Project/SENIOR YEAR/Ares-Design-Software/OpenRocket/RSE files/2000lbf_3s_1500_.RSE')
    ...
    fin4 = TL.Fin(top_pos = fin_position,
                span = fin_span,
                thickness=fin_thickness,
                Ct=fin_Ct,
                Cr=fin_Cr,
